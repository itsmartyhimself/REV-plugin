...
export interface KnobSmallProps {
  defaultAngle?: number;
  ariaLabel?: string;
...
const KnobSmall = React.forwardRef<HTMLDivElement, KnobSmallProps>(
  (
    {
      defaultAngle = 0,
      ariaLabel = "Small knob",
      className,
      onValueChange,
    },
    ref
    ...
    return (
      ...
      >
        {/* Outer shell (stable 44x44 footprint) - visual only */}
        <div
        ...
        >
          ...
          <motion.button
            ...
            style={{
              ...
              borderRadius: "var(--radius-full)",
              boxShadow: "0px 0px 2px 4px rgba(13, 14, 15, 0.8)",
...
KnobSmall.displayName = "KnobSmall";
